        ...
        <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">Front End Developer</h2>
                    <p className="mt-6 text-lg leading-8 text-gray-300">
                        Si necesitas crear una página web para tu negocio, soy el programador que buscas. Te ofrezco grandes beneficios, como el diseño, la maquetación, el mantenimiento y el posicionamiento de tu página web, para que puedas ingresar al mercado de las tiendas en línea.
                    </p>
                </div>
                <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
                    ...
                    <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div className="flex flex-col-reverse">
                            ...
                            <dd className="text-2xl font-bold leading-9 tracking-tight text-white">+5 años</dd>
                        </div>
                        <div className="flex flex-col-reverse">
